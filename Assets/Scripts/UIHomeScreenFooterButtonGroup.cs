...
public class UIHomeScreenFooterButtonGroup : MonoBehaviour
{
    ...
    {
        _isLocked = isLocked;
        _grpButton.targetGraphic = isLocked ? _lockImage : _iconImage;
    ...
    private void UpdateGroupRect(float tm)
    {
        ...
        //var actualImgRectVec4 = Vector4.Lerp(_inactiveGrpIconRect, _activeGrpIconRect, tm);
        //_iconRectTransform.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, actualImgRectVec4.w);
    }
